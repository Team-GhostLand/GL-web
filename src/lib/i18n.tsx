...
const dict = {
  pl: {
    ...
    "nav.lore": "Lore",
    "hero.subtitle": "Edycja 8 · NEOFORGE 1.21.1 · immersja, przygoda, technologia i aeronautyka!",
  ...
  en: {
    ...
    "nav.lore": "Lore",
    "hero.subtitle": "Edition 8 · NEOFORGE 1.21.1 · immersion, adventure, technology and aeronautics!",
