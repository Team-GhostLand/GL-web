...
const dict = {
  pl: {
    ...
    "nav.lore": "Lore",
    "hero.subtitle": "Edycja 8.0 · Fabric 1.20.1 · immersja, przygoda, technologia i wspólne gotowanie.",
    "hero.description": "Pół-prywatny modpack skupiony na dobrej atmosferze i wspólnym budowaniu świata.",
  ...
  en: {
    ...
    "nav.lore": "Lore",
    "hero.subtitle": "Edition 8.0 · Fabric 1.20.1 · immersion, adventure, tech and shared cooking.",
    "hero.description": "A semi-private modpack focused on good vibes and building the world together.",
